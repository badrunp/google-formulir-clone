            ...
            <div class="container mx-auto">
                <div class="w-full flex flex-row items-center justify-between">
                    ...
                    <div class="flex flex-row items-center space-x-3">
                        ...
                        <div class="text-gray-600 relative" x-data="{open: false}">
                            <div class="flex items-center space-x-1 cursor-pointer" @click="open = ! open">
                                <h5 class="block text-base tracking-wide">Muhammad Badrun</h5>
                            ...
                            <ul x-show="open" :class="{'absolute': true, 'hidden':false}" @click.away="open=false" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="transform translate-y-3 opacity-0" x-transition:enter-end="transform translate-y-0 opacity-100" x-transition:leave="transition ease-out duration-150" x-transition:leave-start="transform translate-y-0 opacity-100" x-transition:leave-end="transform translate-y-3 opacity-0" class="hidden top-0 right-0 w-full bg-white mt-12 py-1 rounded-md shadow">
                                <li>
